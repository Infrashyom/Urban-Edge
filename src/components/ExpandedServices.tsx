...
const services = [
  ...
  },
  {
    ...
    mediaType: "image",
    mediaSrc: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=1200",
  ...
  },
  {
    ...
    mediaType: "image",
    mediaSrc: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?auto=format&fit=crop&q=80&w=1200",
  ...
  },
  {
    ...
    mediaType: "image",
    mediaSrc: "https://images.unsplash.com/photo-1598550476439-6847785fcea6?auto=format&fit=crop&q=80&w=1200",
  ...
  },
  {
    ...
    mediaType: "image",
    mediaSrc: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=1200",
  ...
  },
  {
    ...
    mediaType: "image",
    mediaSrc: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&q=80&w=1200",
...
export default function ExpandedServices({ hideLink = false }: { hideLink?: boolean }) {
  return (
    <section className="py-14 sm:py-20 bg-sky-50 relative">
