...
export default function ValueProp() {
  ...
  return (
    <section ref={containerRef} className="py-14 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6">
            {[
              ...
              { number: "50K+", label: "Impressions" },
              { number: "20+", label: "Total Clients" },
