...
export default function Contact() {
  ...
  return (
    <section className="py-14 sm:py-20 px-4 sm:px-6 md:px-12 relative bg-sky-50 min-h-[85vh] flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <div className="p-3 rounded-full bg-sky-100 text-sky-600 group-hover:bg-rose-500 group-hover:text-white transition-colors">
                  <Instagram size={20} />
                </div>
                <div>
                  <p className="font-sans text-xs uppercase tracking-wider text-slate-500 font-medium mb-1">Instagram</p>
                  <p className="font-sans text-slate-900 font-medium group-hover:text-sky-600 transition-colors">@_urban_edge_official</p>
                </div>
              </a>
